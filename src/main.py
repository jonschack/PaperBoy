...
def main():
    ...
    if not entries:
        ...
        # We might still want to run to report "nothing new" or just exit.
        # For now, let's exit to save API calls.
        sys.exit(0)
    ...
    summary_text = summarizer.summarize(entries, config['user_name'], config['interests'])
